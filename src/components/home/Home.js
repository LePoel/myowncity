                ...
                <div className="col-md-5 mb-4 mt-md-4 p-3">
                    <div className="row">
                        ...
                        <div className="col-xs-12 text-center p-3" id="erläuterung">
                            <p id="erklärung">MyCity operates an interactive map that shows places in your neighborhood
                                that have been rated by our community.</p>
                            <p className="fw-semibold">Came across a place you want to tell our community about?</p>
                        </div>
                        <div className="col text-center pt-md-3">
                            <Link to="/reportplace" className="btn btn-primary btn-lg rounded-5" role="button">Report a
                                Place</Link>
                        </div>
                    </div>
                </div>
